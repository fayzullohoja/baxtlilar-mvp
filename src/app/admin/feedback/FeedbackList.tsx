              ...
              {r.screenshot_url && (
                <a href={r.screenshot_url} target="_blank" rel="noreferrer">
                  ...
                  <img
                    ...
                    // В миниатюре лежит ОРИГИНАЛ: уменьшать нечем (sharp в
                    // проекте нет), а скриншот бывает до 5 МБ. Без lazy браузер
                    // на открытии страницы дёргал бы разом все картинки списка,
                    // и отдающий роут читал бы каждую целиком в память одного
                    // Node-процесса. С lazy грузится то, что человек реально
                    // домотал до экрана.
                    loading="lazy"
